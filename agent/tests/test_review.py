...
def test_format_summary_comment_includes_attribution() -> None:
    ...
    assert "Cogito Review" in summary
    assert COGITO_REVIEW_REPO_URL in summary
    assert summary.endswith(
        f"*Review generated by [Cogito Review]({COGITO_REVIEW_REPO_URL}).*"
    )
    ...
    assert COGITO_REVIEW_REPO_URL in with_findings
